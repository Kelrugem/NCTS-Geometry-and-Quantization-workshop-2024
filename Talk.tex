...
\begin{tikzpicture}
%\draw[black, fill=black, -{Triangle[width = 18pt, length = 8pt]}, line width = 5pt] (0,1.7) edge node[above] {Covariantization} (14,1.7);
\coordinate (a) at (0, 0);
\coordinate (b) at (14.8, 0);
\path[->] (a) (b)
%\node[single arrow, draw=black, line width=.0000003, fill=black,
      %%minimum width = 3pt, 
